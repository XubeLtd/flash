...
2. Install the tool that matches the device you're flashing. Skip this step if you're only ever using `bun push`.
   ...
   | Sun Gen 2      | `pip install pyocd`, [LinkServer](https://www.nxp.com/design/design-center/software/development-software/mcuxpresso-software-and-tools-/linkserver-for-microcontrollers:LINKERSERVER)<br>Mac/Linux:<br>- `pyocd pack install NXP.RW612_DFP`<br>Windows:<br> - get [libusb](https://github.com/libusb/libusb/releases/download/v1.0.29/libusb-1.0.29.7z) and copy libusb-1.0.29.7z\VS2022\MS64\dll\libusb-1.0.dll to C:\Users\user\AppData\Local\Microsoft\WindowsApps<br>  - get [NXP.RW612_DFP.25.12.00.pack](https://mcuxpresso.nxp.com/cmsis_pack/repo/NXP.RW612_DFP.25.12.00.pack) and extract NXP.RW612_DFP.pdsc<br>  - run `pyocd pack clean`<br>  - run `pack-manager print-cache-dir` to get the cache folder (should be C:\Users\user\AppData\Local\cmsis-pack-manager\cmsis-pack-manager)<br>  - create cache folder and copy NXP.RW612_DFP.pdsc into it<br>  - in cache folder create folder "NXP\RW612_DFP"<br>  - copy file NXP.RW612_DFP.25.12.00.pack into it and rename it as 25.12.00.pack<br>  - run `pack-manager add-packs c:\Users\user\AppData\Local\cmsis-pack-manager\cmsis-pack-manager\NXP.RW612_DFP.pdsc`<br>  - run `pyocd list --targets \| findstr /r \<rw612\>` to check if RW612 target is now found|
